...
var indiceDestino = sucursalDestinoSelect.options[sucursalDestinoSelect.selectedIndex].value;
...
function limpiarRenglones(registrosArchivo, banderaUbicacion) {
    ...
    if (validador(renglonArchivo)) {
        ...
        for (var i = 2; i <= renglonArchivo.length - 1; i++) {
                ...
                if (validador(renglonArchivoTemporal)) {
                    ...
                    if (banderaUbicacion == "origen") {
                        ...
                        if (indiceOrigen == sucursalOrigen) {
                            ...
                            //RENGLONES_ARMADOS_ORIGEN.push(validaCampoReferencia(renglonArchivoTemporal));
